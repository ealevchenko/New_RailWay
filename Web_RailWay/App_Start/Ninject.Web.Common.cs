...
namespace Web_RailWay.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<EFTD.Abstract.IRepository<EFTD.Entities.MarriageDistrict>>().To<EFOC.Concrete.EFMarriageDistrict>();
            kernel.Bind<EFTD.Abstract.IRepository<EFTD.Entities.MarriageDistrictObject>>().To<EFOC.Concrete.EFMarriageDistrictObject>();
