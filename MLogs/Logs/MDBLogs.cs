...
namespace MessageLog
{
    public static class MDBLogs
    {
        ...
        /// <returns></returns>
        public static long SaveEvents(this string events, string status, service service, eventID eventID)
        {
            return DBLogs.SaveEvents(events, status, (service == service.Null ? (int?)null : (int)service), (eventID == eventID.Null ? (int?)null : (int)eventID));
        }

        public static long SaveEvents(this string events, string status, service service)
        {
            return SaveEvents(events, status, service, eventID.Null);
        }

        public static long SaveEvents(this string events, string status, eventID eventID)
        {
            return SaveEvents(events, status, service.Null, eventID);
        }

        public static long SaveEvents(this string events, string status)
        {
            return SaveEvents(events, status, service.Null, eventID.Null);
        }

        public static long SaveEvents(this string events, EventStatus status, service service, eventID eventID)
        {
            return DBLogs.SaveEvents(events, status, (service == service.Null ? (int?)null : (int)service), (eventID == eventID.Null ? (int?)null : (int)eventID));
        }

        public static long SaveEvents(this string events, EventStatus status, service service)
        {
            return SaveEvents(events, status, service, eventID.Null);
        }

        public static long SaveEvents(this string events, EventStatus status, eventID eventID)
        {
            return SaveEvents(events, status, service.Null, eventID);
        }
