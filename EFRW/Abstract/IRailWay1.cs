...
namespace EFRW.Abstract
{
    public interface IRailWay1
    {
        ...
        IQueryable<StationsNodes> GetStationsNodes(int id_station_from, int id_station_on, EFRW.Concrete.EFRailWay1.typeSendTransfer st);
        bool IsRulesTransfer(int id_station_from, int id_station_on, EFRW.Concrete.EFRailWay1.typeSendTransfer st);
        bool IsRulesTransferOfKis(int id_station_from_kis, int id_station_on_kis, EFRW.Concrete.EFRailWay1.typeSendTransfer st);
